...
public class ButtonColumnCellRenderer extends DefaultTableCellRenderer {
    ...
    @Override //método retorna  o componente que vai ser renderizado na célula  
    public Component getTableCellRendererComponent(JTable table, Object value,
        ...
        label.setIcon(new javax.swing.ImageIcon(getClass().getResource("/" + buttonType + ".png"))); //seleciona a fonte do icone
